package com.example.zhkj.lbsdemo;
...
public class SecondActivity extends AppCompatActivity implements AMapNaviViewListener, AMapNaviListener {
    AMapNaviView mAMapNaviView;
    AMapNavi mAMapNavi;
    NaviLatLng mStartLatlng = new NaviLatLng(34.729711, 113.809078);//自定义起点
    NaviLatLng mEndLatlng = new NaviLatLng(34.727777, 113.8083);//自定义起点
